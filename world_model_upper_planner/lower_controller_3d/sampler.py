...
class FootholdSampler:
    ...
    def _sample_candidate(self, ids_sub, swing, stance_pos, stance_yaw):
        ...
        # Sample the goal FIRST. Physical supports are placed afterwards by env.
        target[:, 2] = (stance_pos[:, 2] + self._uniform(c.z_distance, n)).clamp(-0.6, 0.6)
        ...
        if holds.any():
            ...
            target[holds, 2] = stance_pos[holds, 2]
